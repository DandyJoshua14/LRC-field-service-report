...
import { c as create_ssr_component, f as compute_rest_props, h as spread, i as escape_object, j as escape_attribute_value, k as add_attribute, e as escape } from "./index2.js";
const browser = BROWSER;
let userName = writable(browser);
userName.subscribe((val) => browser);
let role = writable(browser);
role.subscribe((val) => browser);
let reports = writable(browser);
reports.subscribe((val) => browser);
let email = writable(browser);
email.subscribe((val) => browser);
let validate = writable(browser);
validate.subscribe((val) => browser);
