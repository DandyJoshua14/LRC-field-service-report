import { c as create_ssr_component, f as compute_rest_props, k as add_attribute, h as spread, i as escape_object, j as escape_attribute_value, e as escape, v as validate_component, l as each, b as subscribe } from "../../../chunks/index2.js";
import { c as classnames, r as reports, u as userName, v as validate, a as role, e as email, C as Container, B as Button } from "../../../chunks/Offcanvas.svelte_svelte_type_style_lang.js";
import "devalue";
...
const css = {
  code: ".form.svelte-141qv6i{text-align:center;display:block}h5.svelte-141qv6i{text-align:left}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-c9ht2j_START -->${$$result.title = `<title>LRC Publisher Report</title>`, ""}<!-- HEAD_svelte-c9ht2j_END -->`, ""}
<body>${$userName ? `${validate_component(Container, "Container").$$render($$result, {}, {}, {
      default: () => {
        return `<div class="${"form svelte-141qv6i"}">${!$validate ? `<form method="${"POST"}" action="${"?/submit"}"><h2 style="${"text-align: center;"}">January Report</h2>
						<br>
						<h5 class="${"svelte-141qv6i"}">Name:</h5>
          ...
          {}
						...
						<br>
						<br>
						<h5 class="${"svelte-141qv6i"}">Hours:</h5>
						${validate_component(Input, "Input").$$render($$result, { name: "hours", type: "number" }, {}, {})}
						<br>
						<br>
						<h5 class="${"svelte-141qv6i"}">Placements:</h5>
						${validate_component(Input, "Input").$$render($$result, { name: "placements", type: "number" }, {}, {})}<br><br>
						<h5 class="${"svelte-141qv6i"}">Return Visits:</h5>
						${validate_component(Input, "Input").$$render($$result, { name: "rv", type: "number" }, {}, {})}<br><br>
						<h5 class="${"svelte-141qv6i"}">Bible Studies:</h5>
						${validate_component(Input, "Input").$$render($$result, { name: "biblestudies", type: "number" }, {}, {})}<br><br>
						<h5 class="${"svelte-141qv6i"}">Videos:</h5>
						${validate_component(Input, "Input").$$render($$result, { name: "videos", type: "number" }, {}, {})}<br><br>
						<h5 class="${"svelte-141qv6i"}">Admin Role:</h5>
						${validate_component(Input, "Input").$$render(
          $$result,
          { name: "role", type: "text", value: $role },
          {
            value: ($$value) => {
              $role = $$value;
              $$settled = false;
          ...
          {}
						...
						<h5 class="${"svelte-141qv6i"}">Email:</h5>
						${validate_component(Input, "Input").$$render(
          $$result,
          {
            name: "role",
        ...
        })}</form>` : `<h3>You&#39;ve already Submitted Your Monthly Report</h3>`}
				<br>
				${$role ? `<h4 style="${"text-decoration: underline dotted;"}">${escape($userName)}(Admin)</h4>
					<br>
					${validate_component(Input, "Input").$$render(
          $$result,
          {
          ...
          {}
					...
					<br>
					${filteredReports ? `${each(filteredReports, (report, index) => {
          return `<div style="${"border: 1px solid black; border-radius: 10px;"}"><h3 style="${"text-align: left; padding: 10px; text-decoration: 2px underline;"}">${escape(index + 1)}. ${escape(report.name)}</h3>
								<p><b>Hours: ${escape(report.hours)}</b></p>
								<hr>
								<p><b>Placements: ${escape(report.placements)}</b></p>
								<hr>
								<p><b>R/V&#39;s: ${escape(report.returnVisits)}</b></p>
								<hr>
								<p><b>Bible Studies: ${escape(report.bibleStudies)}</b></p>
								<hr>
								<p><b>Videos: ${escape(report.videos)}</b></p>
							</div>`;
        })}` : ``}
					<br><br>
    ...
    })}` : `<div><h1 style="${"text-align: center; padding: 20px;"}">Oops!. Sorry All your data was cleared for security reasons. Please <a href="${"/"}">${validate_component(Button, "Button").$$render($$result, { style: "background-color: green;" }, {}, {
      default: () => {
        return `Log In!`;
      }
    })}</a> again to continue
